                        ...
                        <div class="panel-body">
                            ...
                            <form id="form1" name="form1" class="form-horizontal" method="post" action="<?php echo $do_addedit_link;?>" enctype="multipart/form-data" onsubmit="return validate_data()">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="title" id="title" class="content mytextarea"><?php echo $title;?></textarea>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cardholder_name">Web Ad Icon [Width:785px,Height:505px] <span class="required">*</span></label>
                                    <div class="col-sm-9">
                                        ...
                                        <br>
                                        <div id="r_pic" style="<?php if(trim($icon) == ''){ ?>display:none;<?php }else{ ?>display:block;<?php } ?>"><img src="<?php echo file_upload_base_url().'left_adsection/'.$icon;?>" width="100" height="100" ></div>
