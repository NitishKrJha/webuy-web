                                        ...
                                        <?php if(!empty($recordset)){ $i=2; ?>
                                            ...
                                            foreach($recordset as $singleRecord){
                                                ...
                                                <tr class="<?php echo $i%2==0?'even':'odd'; ?> pointer">
                                                    ...
                                                    <td class=" last"><a href="<?php echo $ediLink; ?>" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a> | <a href="javascript:deleteadsection('<?php echo $deleteLink;?>');" title=" Delete Content "><i aria-hidden="true" class="fa fa-trash"></i></a></td>
                                                </tr>
                                                <?php $i++; }
...
<script type="text/javascript">
    function changeOrder(val,id){
        ...
        $.ajax({
            type:'POST',
            url:'<?php echo base_url('landing/category_wise_product_changeorder')?>',
            data:{val:val,id:id},
            dataType:'JSON',
