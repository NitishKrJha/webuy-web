...
<div class="content">
    <div class="">
        <div class="page-header-title">
            <h4 class="page-title">Left Ad Section</h4></div>
    </div>
                                        ...
                                        <?php if(!empty($recordset)){ $i=2; ?>
                                            ...
                                            foreach($recordset as $singleRecord){
                                                ...
                                                <tr class="<?php echo $i%2==0?'even':'odd'; ?> pointer">
                                                    ...
                                                    <td class=""><img src="<?php echo file_upload_base_url().'left_adsection/'.$singleRecord['icon']?>" width="100" height="100" ></td>
                                                    ...
                                                    <td class=" last"><a href="<?php echo $ediLink; ?>" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a> <?php if(count($recordset)>4) {?>| <a href="javascript:deleteadsection('<?php echo $deleteLink;?>');" title=" Delete Content "><i aria-hidden="true" class="fa fa-trash"></i></a><?php } ?></td>
                                                </tr>
                                                <?php $i++; }
...
<script type="text/javascript">
    function changeOrder(val,id){
        ...
        $.ajax({
            type:'POST',
            url:'<?php echo base_url('landing/left_adsection_changeorder')?>',
            data:{val:val,id:id},
            dataType:'JSON',
