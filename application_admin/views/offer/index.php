                    ...
                    <div class="container">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" aria-controls="example" name="searchField">
                                                    <option value="">-Select-</option>
                                                     <option value="various_offer.offer_name" <?php if(isset($params['searchField']) && $params['searchField']=='various_offer.offer_name') echo 'selected';?>>Offer Name</option>
                        ...
                        <thead>
                                                        <tr>
                                                            ...
                                                            <th class="column-title">Cotegory</th>
                                                            <th class="column-title">Amount type</th>
                                                            <th class="column-title">Actual Amount</th>
                                                            <th class="column-title">Short Description</th>
                                                            <th class="column-title">Amount Limit</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php $i=1; foreach($recordset as $singleRecord){ 
                                                          $ediLink = str_replace('{{ID}}', $singleRecord['offer_id'], $edit_link);
                                                          $pwd_link= str_replace('{{ID}}', $singleRecord['offer_id'], $pwd_link);
                                                          $activeLink = str_replace('{{ID}}',$singleRecord['offer_id'],$activated_link);
                                                            $inacttivedLink = str_replace('{{ID}}',$singleRecord['offer_id'],$inacttived_Link);
                                                             $deleteLink = str_replace('{{ID}}', $row['id'], $delete_link);
                                                        ?>
                        <tr class="<?php echo $i%2==0?'even':'odd'; ?> pointer">
                        <td class=" "><?php echo $i+$startRecord; ?></td>
                        <td class=" "><?php echo $singleRecord['offer_name']; ?></td>
                        <td class=" "><?php echo $singleRecord['name']; ?></td>
                        <td class=" "><?php echo $singleRecord['offer_type']; ?></td>
                        <td class=" "><?php echo $singleRecord['offer_amount']; ?></td>
                        <td class=" "><?php echo $singleRecord['short_description']; ?></td>
                        <td class=" "><?php echo $singleRecord['offer_limit']; ?></td>
                        ...
                        <a href="<?php echo base_url('offer/viewdetails/'.$singleRecord['offer_id']) ?>" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>||
                        <a href="javascript:void(0)" onclick="deleteoffer('<?php echo base_url('offer/delete/'.$singleRecord['offer_id']); ?>')" title="Delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                        </tr>
                        <?php  $i++; } 
