                                                ...
                                                <table id="tech-companies-1" class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php $i=1; foreach($recordset as $singleRecord){ 
                                                          $ediLink = str_replace('{{ID}}', $singleRecord['merchants_id'], $edit_link);
                                                          $pwd_link= str_replace('{{ID}}', $singleRecord['merchants_id'], $pwd_link);
                                                          $activeLink = str_replace('{{ID}}',$singleRecord['merchants_id'],$activated_link);
                                                            $inacttivedLink = str_replace('{{ID}}',$singleRecord['merchants_id'],$inacttived_Link);
                                                        ?>
                                                        <tr class="<?php echo $i%2==0?'even':'odd'; ?> pointer">
                                                         ...
                                                         <a href="<?php echo base_url('merchants/viewdetails/'.$singleRecord['merchants_id']) ?>" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>||
                                                         <a href="javascript:void(0)" onclick="deletemerchants('<?php echo base_url('merchants/delete/'.$singleRecord['merchants_id']); ?>')" title="Delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a>||
