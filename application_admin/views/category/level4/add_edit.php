                    ...
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            ...
                            <?php //echo validation_errors(); ?>
                              ...
                              <div class="form-group">
                                 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cardholder_name">Category Level 3<span class="required">*</span></label>
                                 <div class="col-sm-9">
                                    <select name="level3" id="level3" class="form-control">
                                      <option value="">Please Select</option>
                                      <?php
                                        if(count($level3_data) > 0){
                                          foreach ($level3_data as $key => $value) {
    				                  ...
    				                  <div class="form-group">
    				                    ...
    				                    <div class="col-sm-9"> 
    				                        ...
    				                        <br>
    				                        <div id="r_pic" style="<?php if(trim($icon) == ''){ ?>display:none;<?php }else{ ?>display:block;<?php } ?>"><img src="<?php echo file_upload_base_url().'category/level4/'.$icon;?>" width="100" height="100" ></div>
