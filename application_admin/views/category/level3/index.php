                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" aria-controls="example" name="searchField">
                                                    <option value="">-Select-</option>
                                                     <option value="category_level_3.name" <?php if(isset($params['searchField']) && $params['searchField']=='category_level_3.name') echo 'selected';?>>Name</option>
                                                     <option value="category_level_2.name" <?php if(isset($params['searchField']) && $params['searchField']=='category_level_2.name') echo 'selected';?>>Level 1 Name</option>
                                                 </select>
                                            </div>
                                        ...
                                        <div class="table-rep-plugin">
                                            ...
                                            <div class="table-responsive b-0" data-pattern="priority-columns">
                                              ...
                                              <th class="column-title">Order</th>
                                                    ...
                                                    <th class="column-title">Category Level 2</th>
                                            ...
                                            foreach($recordset as $singleRecord){ 
                                              ...
                                              <td class=""><img src="<?php echo file_upload_base_url().'category/level3/'.$singleRecord['icon']?>" width="50" height="50" ></td>
                                                    <td class=" "><?php echo $singleRecord['name']; ?></td>
                                                    <td class=" "><?php echo $singleRecord['level2_name']; ?></td>
