            ...
            <div class="content">
                <div class="">
                    <div class="page-header-title">
                        <h4 class="page-title">Category Level1</h4></div>
                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" aria-controls="example" name="searchField">
                                                    <option value="">-Select-</option>
                                                     <option value="category_level_1.name" <?php if(isset($params['searchField']) && $params['searchField']=='category_level_1.name') echo 'selected';?>>Name</option>
                                                 </select>
                                            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="table-rep-plugin">
                                            ...
                                            foreach($recordset as $singleRecord){ 
                                              ...
                                              <td class=""><img src="<?php echo file_upload_base_url().'category/level1/'.$singleRecord['icon']?>" width="50" height="50" ></td>
