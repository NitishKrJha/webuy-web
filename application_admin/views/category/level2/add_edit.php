                              ...
                              <select name="level1" id="level1" class="form-control">
                                ...
                                <?php
                                  if(count($level1_data) > 0){
                                    foreach ($level1_data as $key => $value) {
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-9"> 
				                        ...
				                        <br>
				                        <div id="r_pic" style="<?php if(trim($icon) == ''){ ?>display:none;<?php }else{ ?>display:block;<?php } ?>"><img src="<?php echo file_upload_base_url().'category/level2/'.$icon;?>" width="100" height="100" ></div>
