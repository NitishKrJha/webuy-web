            ...
            <div class="content">
                <div class="">
                    <div class="page-header-title">
                        <h4 class="page-title">Newsletter Subscriber</h4></div>
                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" aria-controls="example" name="searchField">
                                                    <option value="">-Select-</option>
                                                     <option value="subscriber.email" <?php if(isset($params['searchField']) && $params['searchField']=='subscriber.email') echo 'selected';?>>Email</option>
                                                 </select>
                                            </div>
                                        ...
                                        <div class="table-rep-plugin">
                                            ...
                                            <div class="table-responsive b-0" data-pattern="priority-columns">
                                              ...
                                              <!-- <th class="column-title">Order</th> -->
                                                    ...
                                                    <th class="column-title">Subscriber Email </th>
                                            ...
                                            foreach($recordset as $singleRecord){ 
                                              ...
                                              <td class=""><?php echo $singleRecord['email']?></td>
                                                    <td class=" "><?php echo $singleRecord['join_dt']; ?></td>
                                                   
                                                     <?php if($singleRecord['is_verify']==1){?>
                                                     <td>
                                                      <span class="label label-success">Verified</span>
                                                     </td>
                                                     <?php } ?>
                                                     <?php if($singleRecord['is_verify']==0){?>
                                                     <td>
