                        ...
                        <div class="panel-body">
							...
							<form id="form1" name="form1" class="form-horizontal" method="post" action="<?php echo $do_addedit_link;?>" enctype="multipart/form-data">
				                ...
				                <div class="form-group">
				                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cardholder_name">Brands Name<span class="required">*</span></label>
				                    <div class="col-sm-9">
										<input type="text" name="name" class="form-control" value="<?php echo $name ?>">
									</div>
				                </div>
				                <div class="form-group">
				                	<label class="control-label col-md-3 col-sm-3 col-xs-12" for="cardholder_name">Brands Logo  <span class="required">*</span></label>
				                    <div class="col-sm-9"> 
				                        ...
				                        <br>
				                        <div id="r_pic" style="<?php if(trim($icon) == ''){ ?>display:none;<?php }else{ ?>display:block;<?php } ?>"><img src="<?php echo file_upload_base_url().'brands/'.$icon;?>" width="100" height="100" ></div>
