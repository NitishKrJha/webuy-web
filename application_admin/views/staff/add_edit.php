                        ...
                        <div class="panel-body">
							...
							<form id="form1" name="form1" class="form-horizontal" action="<?php echo $do_addedit_link;?>" method="post" enctype="multipart/form-data" autocomplete="off">
								<span class="section"></span>
									...
									<div class="form-group">
					                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">User Type *</label>
					                    <div class="col-md-6 col-sm-6 col-xs-12">
					                ...
					                <div class="form-group">
					                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Zipcode <span class="required">*</span></label>
					                    <div class="col-md-6 col-sm-6 col-xs-12">
...
if(country !=0){
  ...
  function getState(val){
   ...
   // alert(state);
    if(val!=''){
      var url='<?php echo base_url(); ?>staff/getState/'+val+'/'+state;
      $.ajax({
        type: 'POST',
        url: url,
  ...
  function getCity(val){
    ...
    if(val!=''){
      var url='<?php echo base_url(); ?>staff/getCity/'+val+'/'+city;
      $.ajax({
        type: 'POST',
        url: url,
        success: function(result){
	...
	$("form[name='form1']").validate({
      ...
      rules: {
        ...
        username:{
          required: true,
          remote: {
	            url: "<?php echo base_url(); ?>staff/checkuser/username/<?php echo $id; ?>",
	            type: "post"
	      }
        },
        email:{
          ...
          email: true,
	      remote: {
	            url: "<?php echo base_url(); ?>staff/checkuser/email/<?php echo $id; ?>",
	            type: "post"
	      }
        },
        phone:{
          ...
          number: true,
          remote: {
	            url: "<?php echo base_url(); ?>staff/checkuser/phone/<?php echo $id; ?>",
	            type: "post"
	      }
        },
        <?php if($action=='Add'){ ?>
