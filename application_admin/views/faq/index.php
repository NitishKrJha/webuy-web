            ...
            <div class="content">
                ...
                <div class="page-content-wrapper ">
                    <div class="container">
                        ...
                        <td class=" "><?php echo $singleRecord['question']; ?></td>
                        ...
                        <a href="<?php echo base_url('faq/viewdetails/'.$singleRecord['id']) ?>" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>||
                        <a href="javascript:void(0)" onclick="deletefaq('<?php echo base_url('faq/delete/'.$singleRecord['id']); ?>')" title="Delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                        </tr>
                        <?php  $i++; } 
