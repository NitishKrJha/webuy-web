                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" aria-controls="example" name="searchField">
                                                    <option value="">-Select-</option>
                                                     <option value="variation_attribute.name" <?php if(isset($params['searchField']) && $params['searchField']=='variation_attribute.name') echo 'selected';?>>Name</option>
                                                 </select>
                                            </div>
                                            ...
                                            foreach($recordset as $singleRecord){ 
                                              ...
                                              <td class=" "><?php echo $i+$startRecord; ?></td>
                                               <td class=""><?php echo $singleRecord['name']?></td>
                                                    ...
                                                    <td class=" last"><a href="<?php echo $ediLink; ?>" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a> <?php if(count($recordset)!=0) {?>| <a href="<?php echo $deleteLink;?>" title=" Delete Content "><i aria-hidden="true" class="fa fa-trash"></i></a><?php } ?></td>
                                                  </tr>
                                                <?php $i++; } 
...
<script type="text/javascript">
  function changeOrder(val,id){
    ...
    $.ajax({
      type:'POST',
      url:'<?php echo base_url('variation/changeorder')?>',
      data:{val:val,id:id},
      dataType:'JSON',
