...
<div class="content">
    <div class="">
        <div class="page-header-title">
            <h4 class="page-title">Banner</h4></div>
    </div>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-body">
							...
							<form id="form1" name="form1" class="form-horizontal" method="post" action="<?php echo $do_addedit_link;?>" enctype="multipart/form-data" onsubmit="return validate_data()">
				                ...
				                <div class="form-group">
				                	<label class="control-label col-md-3 col-sm-3 col-xs-12" for="cardholder_name">Web Banner Icon [Width:1300px,Height:605px] <span class="required">*</span></label>
				                    <div class="col-sm-9"> 
				                ...
				                <div class="form-group">
				                	<label class="control-label col-md-3 col-sm-3 col-xs-12" for="cardholder_name">App Banner Icon [Width:1300px,Height:605px] <span class="required">*</span></label>
				                    <div class="col-sm-9"> 
				                        ...
				                        <br>
				                        <div id="r_pic" style="<?php if(trim($icon_app) == ''){ ?>display:none;<?php }else{ ?>display:block;<?php } ?>"><img src="<?php echo file_upload_base_url().'banner/'.$icon_app;?>" width="100" height="100" ></div>
